		...
		<div class="panel-body">
				<form id="mainForm" role="form" class="form-horizontal" method="post" action="">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="username" id="username" value="<?php echo ((isset($result["username"]) && ($result["username"] !== ""))?($result["username"]):''); ?>" placeholder="">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="field-1">签名</label>	
						<div class="col-sm-6">
							<input type="text" class="form-control" name="sign" id="sign" value="<?php echo ((isset($result["sign"]) && ($result["sign"] !== ""))?($result["sign"]):''); ?>" placeholder="">
							<p class="help-block"></p>
						</div>
					</div>
					...
					<div class="form-group-separator"></div>
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="email" id="email" value="<?php echo ((isset($result["email"]) && ($result["email"] !== ""))?($result["email"]):''); ?>" placeholder="">
							<p class="help-block"> </p>
						</div>
					</div>
						<div class="form-group-separator"></div>
						<div class="form-group">
						<label class="col-sm-2 control-label" for="field-1">爱心值</label>	
						<div class="col-sm-6">
							<input type="text" class="form-control" name="love_value" readonly  unselectable="on" id="love_value" value="<?php echo ((isset($result["love_value"]) && ($result["love_value"] !== ""))?($result["love_value"]):''); ?>" placeholder="">
							<p class="help-block"> </p>
						</div>
					</div>
					...
					<div class="form-group-separator"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="field-5">ID</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="cu_id" readonly  unselectable="on" id="cu_id" value="<?php echo ((isset($result["cu_id"]) && ($result["cu_id"] !== ""))?($result["cu_id"]):''); ?>" placeholder="">
							</div>
						</div>

						<div class="form-group-separator"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="field-5">绑定手机号</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="phone" readonly  unselectable="on" id="phone" value="<?php echo ((isset($result["phone"]) && ($result["phone"] !== ""))?($result["phone"]):''); ?>" placeholder="">
							</div>
						</div>

						<div class="form-group-separator"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="field-5">家乡省份</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="" id="home_province" readonly  unselectable="on" value="<?php echo get_province($result['home_province']);?>" placeholder="">
							</div>
						</div>

						<div class="form-group-separator"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="field-5">家乡城市</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="" id="home_city" readonly  unselectable="on" value="<?php echo get_city($result['home_city']);?>" placeholder="">
							</div>
						</div>

						<div class="form-group-separator"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="field-5">收件地址</label>
							<div class="col-sm-6">
								<textarea class="form-control" cols="5" id="express_address" name="express_address"><?php echo ((isset($result["express_address"]) && ($result["express_address"] !== ""))?($result["express_address"]):''); ?></textarea>
							</div>
						</div>

						<div class="form-group-separator"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="field-5">是否实名认证</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" readonly  unselectable="on" name="is_auth" id="is_auth" value="
								<?php if($result['is_auth'] == 1): ?>已认证
						...
						<div class="form-group-separator"></div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="field-5">姓名</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" readonly  unselectable="on" name="auth_name" id="auth_name" value="<?php echo ((isset($result["auth_name"]) && ($result["auth_name"] !== ""))?($result["auth_name"]):''); ?>" placeholder="">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" readonly  unselectable="on" name="auth_id" id="auth_id" value="<?php echo ((isset($result["auth_id"]) && ($result["auth_id"] !== ""))?($result["auth_id"]):''); ?>" placeholder="">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<textarea class="form-control" cols="5" id="remark" name="remark"><?php echo ((isset($result["remark"]) && ($result["remark"] !== ""))?($result["remark"]):''); ?></textarea>
							</div>
						</div>
			<!-- 	
					<div class="form-group-separator"></div> 
					<div style="height: 80px" class="form-group"> <a style="color: red" href="<?php echo U('jiuzhu/img_detail',array('img_id'=>$result['id'],'type'=>3));?>">查看原图（请保存后再查看）</a>
 ...
 //=======================================================
    ...
    $('.file').on('change',function(e){
      ...
      $('.submit').click(function(){
	            $.ajax({
	                type:'POST',
	                url :"<?php echo U('/manager/user/edit');?>",
	                data:$('form').serialize(),
	                success:function(msg){
	                	console.log(msg)
	                if(msg == 1){
	                       toastr.success('操作成功')
	                         setTimeout(function(){window.location.href="<?php echo U('Relaxed/index');?>"},2000);
