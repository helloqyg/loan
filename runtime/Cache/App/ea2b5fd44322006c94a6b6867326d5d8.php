...
.show_span{
    ...
    <div class="follow">
        ...
        <main class="main">
          ...
          <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v['type'] == 2): ?><a href="<?php echo U('Dream/detail',array('id'=>$v['item_id']));?>"><?php endif; ?>
            <?php if($v['type'] == 1): ?><a href="<?php echo U('Index/loveRelife',array('id'=>$v['item_id']));?>"><?php endif; ?>

            
           
                <ul class="container1">
                    <li class="img1">
                        <img style="border-radius:50%" src="<?php echo get_user_img($v['user_id']);?>" alt="">
                    </li>
                    <li class="cont1">
                        <h6><?php echo get_follow_detail($v['item_id'],$v['type'])['title'];?></h6>
                        <p style="color:#2ab2f6;">
                            <?php if(get_follow_detail($v['item_id'],$v['type'])['status'] == 3): ?>筹款中<?php endif; ?>
                            <?php if(get_follow_detail($v['item_id'],$v['type'])['status'] == 4): ?>已结束<?php endif; ?>
                           
                            
                        </p>
                        <p><?php echo get_diff_time(get_follow_detail($v['item_id'],$v['type'])['title']);?></p>
                    </li>
