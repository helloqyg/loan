...
.up span {
  ...
  align-items: center;
		...
		<div class="panel-body">
				<?php if(is_array($imgArray)): $k = 0; $__LIST__ = $imgArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><div style="max-width: 500px"> 
					<h3>第<?php echo ($k); ?>张</h3>
