...
.show_span{
    ...
    <div class="faqi">
        ...
        <main class="main">
            <ul class="top">
                <li  <?php if($_GET["id"] == 1): ?>class="h"<?php endif; ?>><a href="<?php echo U('faqi',array('id'=>1));?>">待认证</a></li>
                 <li  <?php if($_GET["id"] == 2): ?>class="h"<?php endif; ?>><a href="<?php echo U('faqi',array('id'=>2));?>">待审核</a></li>
                 <li  <?php if($_GET["id"] == 3): ?>class="h"<?php endif; ?>><a href="<?php echo U('faqi',array('id'=>3));?>">筹款中</a></li>
                 <li  <?php if($_GET["id"] == 4): ?>class="h"<?php endif; ?>><a href="<?php echo U('faqi',array('id'=>4));?>">已结束</a></li>
            </ul>

           <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="
            <?php if($_GET["id"] == 1): echo U('Release/share',array('id'=>$v['id'])); endif; ?>

            <?php if($_GET["id"] != 1): echo U('index/loveRelife',array('id'=>$v['id'])); endif; ?>
            ...
            <ul class="container">
                ...
                <li class="right">
                    ...
                    <p style="color:#2ab2f6;">
                <?php if($_GET["id"] == 1): ?>待提交认证<?php endif; ?>
                <?php if($_GET["id"] == 2): ?>待审核<?php endif; ?>
                <?php if($_GET["id"] == 3): ?>筹款中<?php endif; ?>
                <?php if($_GET["id"] == 4): ?>已接受<?php endif; ?>


                    </p>
                    <p><?php echo get_diff_time($v['date']);?></p>
                </li>
            </ul>
