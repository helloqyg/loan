...
class SmsDemo
{
     ...
     */
    public static function getAcsClient($accessKey,$accessSecret) {
        ...
        $accessKeySecret = $accessSecret; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$code,$accessKey,$accessSecret,$sign,$modeCode) {
        ...
        // 发起访问请求
        $acsResponse = static::getAcsClient($accessKey,$accessSecret)->getAcsResponse($request);
