        ...
        <main class="main">
            ...
            <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="<?php echo U('detail',array('id'=>$v['id']));?>">
                <div class="cont">
                    <!--信息-->
                    <div class="unifo">
                        <span class="img" style="margin-right:0.1rem;">
                    ...
                    <div class="container">
                        ...
                        <div class="right">
                            <p class="tit">慈善募捐 | <?php echo ($v["title"]); ?></p>
                            <!--进度条-->
                            <div class="schedule">
                                <p>
                                    <span class="bac" style="width: <?php echo get_money_ratio($v['id'],3);?>%;"></span>
                                </p>
                                <span><?php echo get_money_ratio($v['id'],3);?>%</span>
                            </div>
                            <div class="bottom">
                               <span>已筹<?php echo get_sum_money($v['id'],3);?>元</span>
