    ...
    <div class="detail">
        <header class="header">
            <p>
                ...
                <span><?php echo ($itemInfo["title"]); ?></span>
        ...
        <main class="main">
            ...
            <div class="top1">
               ...
               <div class="swiper-container">
                ...
                <div>
                    <p class="jin">
                        <span style="width: <?php echo get_money_ratio($itemInfo['id'],1);?>%"></span>
                        <i class="iconfont icon-woniu" style="left:<?php echo get_money_ratio($itemInfo['id'],1);?>%;"></i>
                    </p>
                    <p class="tex1">
                        <span>已筹款<?php echo get_sum_money($_GET['id'],1);?>元</span><span>需筹<?php echo ($itemInfo["target_money"]); ?>元</span>
                    </p>
                </div>
                <!--已经帮助的-->
                <div>
                    ...
                    <p class="nums"><span>已帮助<?php echo get_money_cont($_GET['id'],1);?>次</span></p>
                </div>
                <!--排行榜-->
                <div class="ranking">
                    <p class="left">
        ...
        <footer class="footer">
            <div class="foot">
                <a href="<?php echo U('index/report',array('id'=>$_GET['id'],'type'=>1));?>">
                    <span>
...
$('.icon-pinglun').click(function(){
    ...
    $('.write').click(function(){
     ...
     $.ajax({
            ...
            data:{'donor_id':id,'type':1,'content':text,'item_id':<?php echo ($_GET["id"]); ?>},
    ...
    $('.icon-guanzhu').click(function(){
        ...
        history.go(0) 
         $.ajax({
                ...
                data:{'item_id':<?php echo ($_GET["id"]); ?>,'flag':'add','type':1},
                success:function(msg){
                    console.log(msg)
                if(msg != 0){
    ...
    $('.icon-guanzhu1').click(function(){
        ...
        $.ajax({
                type:'POST',
                url :"<?php echo U('index/follow');?>",
                data:{'item_id':<?php echo ($_GET["id"]); ?>,'flag':'delete','type':1},
                success:function(msg){
                    console.log(msg)
                if(msg != 0){
                        //window.location.href='/release/step2/id/'+msg+'.html'
