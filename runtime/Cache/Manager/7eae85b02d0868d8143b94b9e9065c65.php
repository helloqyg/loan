...
<body class="page-body">
                    ...
                    <div class="row">
                        ...
                        <!--<div class="col-md-12 ">-->
                            <!--<form class="form-search" id="search" method="get" action="">-->
                                ...
                                <!--&lt;!&ndash; <input type="text" name="rep_money"  value="<?php echo ($_GET["rep_money"]); ?>" placeholder="已筹金额"> &ndash;&gt;-->
                                <!--<select name="status">-->
                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><img style="height: 50px;" src="<?php echo ($m["img"]); ?>" alt=""></td>
                                        <td><?php echo get_star_good_cnt($m['id']);?></td>

                                        <td>
                                            <a class="btn btn-info" href="<?php echo U('Star/add',array('id'=>$m['id']));?>"
                                               role="button">修改</a>
                                            <a class="btn btn-warning" href="javascript:void(0);"
                                               onClick="del(<?php echo ($m["id"]); ?>)" role="button">删除</a>
                                        </td>
    ...
    <script type="text/javascript">
        $('.aaa').click(function(){
            window.location.href="<?php echo U('Star/add');?>"
        })
        ...
        function del(aid) {
            if (confirm("确认删除吗")) {
                ...
                $.get("<?php echo U('star/del');?>", {id: aid}, function (data) {
                    if (data.status == 1) {
