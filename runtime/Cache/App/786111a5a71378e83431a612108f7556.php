...
.show_span{
    ...
    <div class="helpIt">
        ...
        <form id="form" action="" method="post"   onsubmit="return checkLength()">
        <main class="main">
            <div class="top">
                <ul>
...
<script >
    ...
    $('.icon-fanhui').click(function(){window.location.href='/favorable/detail/id/<?php echo ($_GET["id"]); ?>.html'})
        var flag = 0;
         ...
         if(flag == 0){
           var ptrr = /^[1-9]+\d*$/
            ...
            $.ajax({
                ...
                data:{'total_price':total_price,'type':3,content:content,is_anonymous:is_anonymous,'item_id':<?php echo ($_GET["id"]); ?>},
