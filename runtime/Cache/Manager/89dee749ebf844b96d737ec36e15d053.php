		...
		<div class="panel-body">
				<form id="mainForm" role="form" class="form-horizontal" method="post" action="">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="ins_name" id="ins_name" value="<?php echo ((isset($result["ins_name"]) && ($result["ins_name"] !== ""))?($result["ins_name"]):''); ?>" placeholder="">
					...
					<div class="form-group-separator"></div>
						 ...
						 <ul class="imgBox ins_logo" id="1">
			                        <?php if(is_array($ins_img)): $i = 0; $__LIST__ = $ins_img;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="img">
...
<div class="form-group">
				...
				<div class="form-group-separator"></div> 
					<div class="form-group">
				  	...
				  	<label class="radio-inline"><input type="radio" checkedname="organization" name="status" 	<?php if($result['status'] == 2): ?>checked<?php endif; ?> value="2">隐藏</label>
