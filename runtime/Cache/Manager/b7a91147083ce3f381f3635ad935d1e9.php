                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($m["auth_name"]); ?></td>
                                        <td> <?php echo ($m["auth_id"]); ?></td>


                                        <td><?php echo (date('Y-m-d H:i',$m["date"])); ?></td>

                                        <!-- <td><?php echo ((isset($m["remark"]) && ($m["remark"] !== ""))?($m["remark"]):'未填'); ?></td> -->

                                        <td>
                                            <a class="btn btn-info" href="<?php echo U('report/img_detail',array('img_id'=>$m['id']));?>" role="button">查看图片</a>
